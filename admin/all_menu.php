                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM tra_banhngot order by id desc";
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    echo '<tr>
                                                            ...
                                                            <td>' . $rows['price'] . '</td>
													        <td>' . $rows['sale'] . '</td>
															<td>' . $rows['introduce'] . '</td>
															<td><div class="col-md-3 col-lg-8 m-b-10">
																<center><img src="' . $rows['img'] . '" class="img-responsive  radius" style="max-height:500px;max-width:550px;" /></center>
																</div>
                                                            </td>
															<td><a href="delete_menu.php?menu_del=' . $rows['id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																<a href="update_menu.php?menu_upd=' . $rows['id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
															</td> 
                                                           </tr>';
                                                }
                                            }
