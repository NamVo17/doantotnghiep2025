                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM account WHERE User_id <> 1 ORDER BY User_id DESC";
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    echo ' <tr>
                                                        ...
                                                        <td>' . $rows['RegisterTime'] . '</td>
                                                        <td>
                                                        <a href="delete_users.php?user_del=' . $rows['User_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
                                                            <i class="fa fa-trash-o" style="font-size:16px"></i>
                                                        </a> 
                                                        <a href="update_users.php?user_upd=' . $rows['User_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
