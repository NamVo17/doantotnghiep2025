...
<head>
    ...
    <link rel="stylesheet"
        href="//bizweb.dktcdn.net/100/492/035/themes/919334/assets/bootstrap-4-3-min.css?1735117293436" />
    <link href="//bizweb.dktcdn.net/100/492/035/themes/919334/assets/paginate.scss.css?1735117293436" rel="stylesheet"
        type="text/css" media="all" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" />

    <link href="//bizweb.dktcdn.net/100/492/035/themes/919334/assets/account_oder_style.scss.css?1735117293436"
                            ...
                            <nav class="header-nav">
                                <ul class="item_big">
                                    ...
                                    <li class="nav-item active">
                                        <a class="a-img" href="index.php" title="Trang chủ">
                                            Trang chủ</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="a-img" href="goithieu.php" title="Giới thiệu">Giới thiệu</a>
                                    </li>
                                    <li class="nav-item has-mega">
                                        <a class="a-img caret-down" href="../index.php#section_product_tab" title="Sản phẩm">Sản phẩm</a>
                    ...
                    <ul class="ul-control">
                        ...
                        <li class="header-wishlist d-flex">
                            <a title="Sản phẩm yêu thích" href="sanphamyeuthich.php" class="button-wishlist">
                                ...
                                <span class="count js-wishlist-count js-wishlist-count-mobile">
                                    <?= $wishlist_count ?>
                                </span>
                            </a>
                        </li>
                                    ...
                                    <div class="page-login pagecustome clearfix no-padding">
                                        <div class="wpx">
                                            ...
                                            <div id="login" class="section">
                                                <form method="post" id="customer_register" accept-charset="UTF-8" onsubmit="return validateForm()">
                                                            ...
                                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                <fieldset class="form-group">
                                                                    <input placeholder="Số điện thoại" type="text"
                                                                        pattern="\d+"
                                                                        class="form-control form-control-comment form-control-lg" id="PhoneNumber"
                                                        ...
                                                        <script>
                                                            function validateForm() {
                                                                ...
                                                                errorMessages.forEach(function(message) {
                                                                    message.textContent = ''; // Xóa thông báo lỗi cũ
                                                                });
                                                                ...
                                                                if (!emailPattern.test(email)) {
                                                                    document.getElementById("emailError").textContent = "Vui lòng nhập email hợp lệ với @gmail.com.";
                                                                    isValid = false;
                                                                }
                                                                ...
                                                                if (!phonePattern.test(phone)) {
                                                                    document.getElementById("phoneError").textContent = "Số điện thoại phải là số hợp lệ và có độ dài từ 10 đến 11 chữ số (chỉ chấp nhận số Việt Nam).";
                                                                    isValid = false;
                                                                }
                                                                ...
                                                                if (password.length <= 8) {
                                                                    document.getElementById("passwordError").textContent = "Mật khẩu phải dài hơn 8 ký tự.";
                                                                    isValid = false;
                                                                }

                                                                // Nếu không có lỗi, trả về true để gửi form
                                                                return isValid;
                                                            }
                                                        </script>
                                                ...
                                                <div class="block social-login--facebooks margin-top-15">
                                                    <p class="a-center"><em>Hoặc đăng nhập bằng</em></p>
                                                    <script>
                                                    ...
                                                    <div style="display: flex;gap: 20px;justify-content: center;">
                                                        <a href="javascript:void(0)" class="social-login--facebook"
                                                            ...
                                                            style="font-size: 30px; color: #1877f2"><i
                                                                class="fa-brands fa-facebook"></i></a>
                                                        <a href="javascript:void(0)" class="social-login--google"
                                                            onclick="loginGoogle()"
                                                            style="font-size: 30px; color: rgb(255, 2, 2)"><i
